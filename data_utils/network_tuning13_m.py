...
def tune_train(net, data_train, optimizer, learning_rate, weight_decay, batch_size=128,  num_epochs=5):
    ...
    return net, train_loss, train_accs


def tune_valid(net, data_valid):
